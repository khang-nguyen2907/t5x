...
from t5x.export_lib import _handle_new_and_old_preprocessor
from t5x.export_lib import _standardize_output_dirs
from t5x.export_lib import _standardize_output_features
from t5x.export_lib import create_inference_function
...
from t5x.export_lib import get_train_state_initializer
from t5x.export_lib import load_params_from_checkpoint
...
def model_validate(
  ...
  preprocessor, _ = _handle_new_and_old_preprocessor(
